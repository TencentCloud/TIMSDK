          ...
          <div class="setting">
            ...
            <div class="setting-footer" @click="getProfile">
              ...
              <div class="setting-more" v-if="showMore">
                <div class="showmore">
                  <div class="show-profile" :class="[showProfile && 'more-selected']" @click="openShowProfile">
                    <span>{{ $t('Home.编辑资料') }}</span>
                  </div>
                  <div>
                    <div @click="openShowReceipt" class="show-receipt" :class="[showReceipt && 'more-selected']">
                      <span>{{ $t('Home.已读回执') }}</span>
                      <i class="icon icon-right-transparent"></i>
                    </div>
                    <div class="receipt-select" v-if="showReceipt">
                      <div
                        class="show-receipt"
                        :class="[showReceipt && needReceipt && 'more-selected']"
                        @click="setReadReceipt(true)"
                      >
                        <span>{{ $t('Home.开启') }}</span>
                        <i v-show="needReceipt" class="icon icon-selected"></i>
                      </div>
                      <div
                        class="show-receipt"
                        :class="[showReceipt && !needReceipt && 'more-selected']"
                  ...
                  <div class="show-about" @click="openShowAbout" :class="[showAbout && 'more-selected']">
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const needReceipt = computed(() => store.state.needReceipt);
    ...
    const openShowReceipt = () => {
      data.showReceipt = !data.showReceipt;
    };
    ...
    const setReadReceipt = (value: boolean) => {
      store.commit('setNeedReceipt', value);
    };
