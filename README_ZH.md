...
## 最新增强版 8.1.6103 @2024.07.26
### SDK
- 长连接支持 http 协议，提升网络穿透能力
- 话题的消息接收选项支持设置是否跟随社群
- 话题增加新的消息接收选项，只接收 @ 消息
- 单聊消息已读回执增加已读时间
- 支持禁用消息发送前和发送后云端回调
- 修复群头像、名称被修改时，会话列表没有实时更新问题
- 修复无网络登录时，拉取分组会话列表异常的问题
- 优化安卓 https 安全问题
- 优化富媒体文件下载鉴权
- 优化安卓的数据库性能

### TUIKit & Demo
- TPush 独立推送产品上线，体积包更小
- Push 新增免登录推送功能
- Push 新增智能探测可用通道策略
- Push 新增推送注册超时保护机制
- TUIChat 优化置顶消息和安全提示的 UI 展示
- TUIChat 国际版 UI 支持“用户正在输入”
- 优化消息收发 UI 体验，减少卡顿问题
