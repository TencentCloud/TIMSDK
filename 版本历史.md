...
## 8.6.7020 @2025.06.03 - 增强版
### SDK
- 修复 iOS 平台的稳定性问题。

## 8.6.7019 @2025.05.28 - 增强版
### SDK
- 推送 SDK 支持多语言国际化。
- 推送 SDK 支持魅族消息分类。
...
## 8.4.6675 @2025.02.11 - 增强版
### SDK
- 修复分页拉取群成员列表异常的问题。

## 8.4.6667 @2025.01.15 - 增强版
### SDK
- 云端支持搜索群资料
- 云端支持搜索用户资料
- 云端支持搜索群成员资料
