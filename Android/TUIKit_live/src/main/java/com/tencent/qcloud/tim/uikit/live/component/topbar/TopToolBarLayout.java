package com.tencent.qcloud.tim.uikit.live.component.topbar;
...
import com.tencent.qcloud.tim.uikit.live.component.topbar.adapter.SpacesDecoration;
import com.tencent.qcloud.tim.uikit.live.component.topbar.adapter.TopAudienceListAdapter;
...
public class TopToolBarLayout extends LinearLayout {
    ...
    public void setAnchorInfo(TRTCLiveRoomDef.LiveAnchorInfo anchorInfo) {
        ...
        if (!TextUtils.isEmpty(anchorInfo.avatarUrl)) {
            Glide.with(TUILiveService.getAppContext()).load(anchorInfo.avatarUrl).into(mImageAnchorIcon);
        } else {
            Glide.with(TUILiveService.getAppContext()).load(R.drawable.live_default_head_img).into(mImageAnchorIcon);
        }
    }
