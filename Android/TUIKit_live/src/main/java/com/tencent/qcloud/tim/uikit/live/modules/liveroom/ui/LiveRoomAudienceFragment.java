...
import com.tencent.qcloud.tim.uikit.live.component.beauty.BeautyParams;
import com.tencent.qcloud.tim.uikit.live.component.common.ActionSheetDialog;
...
import com.tencent.qcloud.tim.uikit.live.component.gift.GiftPanelDelegate;
import com.tencent.qcloud.tim.uikit.live.component.gift.IGiftPanelView;
...
import com.tencent.qcloud.tim.uikit.live.component.gift.imp.GiftPanelViewImp;
...
import com.tencent.qcloud.tim.uikit.live.component.like.LikeFrequencyControl;
...
import com.tencent.qcloud.tim.uikit.live.component.report.ReportController;
...
import com.tencent.qcloud.tim.uikit.live.modules.liveroom.ui.widget.LiveVideoManagerLayout;
...
import static com.tencent.qcloud.tim.uikit.live.base.Constants.REQUEST_LINK_MIC_TIME_OUT;
...
public class LiveRoomAudienceFragment extends BaseFragment implements TopToolBarLayout.TopToolBarDelegate {
            ...
            public void onTextSend(String msg, boolean tanmuOpen) {
                ...
                if (tanmuOpen) {
                    if (mDanmakuManager != null) {
                        mDanmakuManager.addDanmu(TUILiveService.getLoginUserInfo().getFaceUrl(), TUILiveService.getLoginUserInfo().getNickName(), msg);
                    }
    ...
    private void updateBottomFunctionLayout() {
        ...
        // 初始化切换摄像头按钮
        CircleImageView buttonSwitchCam = new CircleImageView(TUILiveService.getAppContext());
    ...
    private void sendGift(GiftInfo giftInfo) {
        ...
        giftInfoCopy.sendUserHeadIcon = TUILiveService.getLoginUserInfo().getFaceUrl();
        ...
        mLiveRoom.followAnchor(userId, new TRTCLiveRoomCallback.ActionCallback() {
            ...
            public void onCallback(int code, String msg) {
                ...
                if (code == 0) {
                    ...
                    Toast.makeText(TUILiveService.getAppContext(), R.string.live_follow_anchor_success, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
