...
public class SwitchCustomWidth extends SwitchCompat {
    ...
    public void initCustomAttr(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray array = context.obtainStyledAttributes(attributeSet, R.styleable.CustomWidthSwitch);
            customSwitchWidth = array.getDimensionPixelSize(R.styleable.CustomWidthSwitch_custom_width, 0);
            array.recycle();
        }
    }
