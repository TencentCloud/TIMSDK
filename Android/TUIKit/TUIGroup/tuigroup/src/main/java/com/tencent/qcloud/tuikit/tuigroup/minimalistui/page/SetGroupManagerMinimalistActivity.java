...
public class SetGroupManagerMinimalistActivity extends BaseLightActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ownerFace.setRadius(ScreenUtil.dip2px(20));
    ...
    private void setClickListener() {
        ...
        setManagerView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SetGroupManagerMinimalistActivity.this, GroupMemberMinimalistActivity.class);
        ...
        managerAdapter.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public void onClick(View view, GroupMemberInfo memberInfo, int position) {
                ...
                View itemPop = LayoutInflater.from(SetGroupManagerMinimalistActivity.this).inflate(R.layout.group_manager_pop_menu, null);
