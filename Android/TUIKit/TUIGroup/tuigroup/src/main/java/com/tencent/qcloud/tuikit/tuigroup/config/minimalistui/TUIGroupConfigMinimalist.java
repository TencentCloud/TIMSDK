package com.tencent.qcloud.tuikit.tuigroup.config.minimalistui;

import androidx.annotation.IntDef;

public class TUIGroupConfigMinimalist {
    private TUIGroupConfigMinimalist() {}

    private static final class TUIGroupConfigMinimalistHolder {
        private static final TUIGroupConfigMinimalist INSTANCE = new TUIGroupConfigMinimalist();
    }

    private static TUIGroupConfigMinimalist getInstance() {
        return TUIGroupConfigMinimalistHolder.INSTANCE;
    }
