package com.tencent.qcloud.tuikit.tuigroup.config.classicui;

import androidx.annotation.IntDef;

public class TUIGroupConfigClassic {
    private TUIGroupConfigClassic() {}

    private static final class TUIGroupConfigClassicHolder {
        private static final TUIGroupConfigClassic INSTANCE = new TUIGroupConfigClassic();
    }

    private static TUIGroupConfigClassic getInstance() {
        return TUIGroupConfigClassicHolder.INSTANCE;
    }
