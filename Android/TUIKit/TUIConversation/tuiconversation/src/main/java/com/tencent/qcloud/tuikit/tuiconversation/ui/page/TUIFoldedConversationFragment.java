...
public class TUIFoldedConversationFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        mFoldedLayout.getConversationList().setOnItemClickListener(new OnItemClickListener() {
            @Override
        ...
        mFoldedLayout.getConversationList().setOnItemLongClickListener(new OnItemLongClickListener() {
            @Override
