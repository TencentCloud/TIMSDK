package com.tencent.qcloud.tuikit.tuitranslation.widget;
...
import com.tencent.qcloud.tuikit.tuitranslation.presenter.TranslationPresenter;
...
public class TranslationMessageLayoutProxy {
    private final String TAG = "PollMessageLayoutProxy";
    ...
    protected void setTranslationContent(BaseFragment fragment, String themeStyle, RecyclerView recyclerView, ViewGroup viewGroup, TUIMessageBean msg) {
        ...
        if (translationStatus == TUIMessageBean.MSG_TRANSLATE_STATUS_SHOWN) {
            ...
            if (TextUtils.equals(themeStyle, TUIConstants.TUIChat.THEME_STYLE_MINIMALIST)) {
                translationText.setTextSize(TypedValue.COMPLEX_UNIT_PX, translationText.getResources().getDimension(com.tencent.qcloud.tuikit.timcommon.R.dimen.chat_minimalist_message_text_size));
            }
    ...
    private void startTranslationLoading(ImageView translationLoadingImage) {
        ...
        RotateAnimation translationRotateAnimation = new RotateAnimation(0, 360, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF, 0.5f);
