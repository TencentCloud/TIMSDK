...
public class ChatBotProfileLayout extends LinearLayout implements View.OnClickListener, IFriendProfileLayout {
    private static final String TAG = ChatBotProfileLayout.class.getSimpleName();
    ...
    public ChatBotProfileLayout(Context context) {
        super(context);
        init();
    }

    public ChatBotProfileLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChatBotProfileLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        inflate(getContext(), R.layout.chat_bot_profile_layout, this);

        mHeadImageView = findViewById(R.id.chat_bot_icon);
        mNickNameView = findViewById(R.id.chat_bot_nick_name);
        mIDView = findViewById(R.id.chat_bot_account);
        mSignatureTagView = findViewById(R.id.chat_bot_signature_tag);
        mSignatureView = findViewById(R.id.chat_bot_signature);
        mMessageOptionView = findViewById(R.id.chat_bot_msg_rev_opt);
        mMessageOptionView.setOnClickListener(this);
        clearMessageBtn = findViewById(R.id.btn_chat_bot_clear_chat_history);
        clearMessageBtn.setOnClickListener(this);

        mTitleBar = findViewById(R.id.chat_bot_profile_titlebar);
