...
public class TUIChatBotUtils {
    ...
    public static void checkChatBotAbility(long param, IUIKitCallback<Boolean> callback) {
    ...
    public static void showNotSupportDialog(Context context) {
        String content = context.getResources().getString(R.string.chat_bot_unsupport_tips);
        String buyingGuidelines = context.getResources().getString(R.string.chat_bot_buying_guidelines);
        ...
        TUIKitDialog.TUIIMUpdateDialog.getInstance()
                ...
                .setPositiveButton(context.getResources().getString(R.string.chat_bot_i_know),
