...
public class VideoModel {
    ...
    private int                        fps           = RoomConstant.DEFAULT_VIDEO_FPS;
    private int                        bitrate       = RoomConstant.DEFAULT_VIDEO_BITRATE;
    private TUIRoomDefine.VideoQuality resolution    = RoomConstant.DEFAULT_VIDEO_RESOLUTION;
    ...
    public void setFps(int fps) {
        this.fps = fps;
        RoomEventCenter.getInstance().notifyEngineEvent(LOCAL_VIDEO_FPS_CHANGED, null);
    }
    ...
    public void setResolution(TUIRoomDefine.VideoQuality resolution) {
        ...
        RoomEventCenter.getInstance().notifyEngineEvent(LOCAL_VIDEO_RESOLUTION_CHANGED, null);
    }
