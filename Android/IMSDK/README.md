...
In addition, we also provide SDKs for the C and C++ API, which you can download from here，[Download C API Edition](https://im.sdk.qcloud.com/download/plus/8.5.6864/cross_platform/ImSDK_Android_C_8.5.6864.zip)、[Download  C++ API Edition](https://im.sdk.qcloud.com/download/plus/8.5.6864/cross_platform/ImSDK_Android_CPP_8.5.6864.zip)。
