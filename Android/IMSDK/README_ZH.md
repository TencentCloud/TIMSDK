...
<table >
  ...
  <tr >
     ...
     <td style="text-align:center"><a href="https://im.sdk.qcloud.com/download/plus/7.9.5666/imsdk-plus-7.9.5666.aar">imsdk-plus.aar</a></td>
  </tr>
</table>
...
此外，我们还提供了 C 接口和 C++ 接口的 SDK，您可以从这里下载：[下载 C API 版本](https://im.sdk.qcloud.com/download/plus/7.9.5666/cross_platform/ImSDK_Android_C_7.9.5666.zip)、[下载 C++ API 版本](https://im.sdk.qcloud.com/download/plus/7.9.5666/cross_platform/ImSDK_Android_CPP_7.9.5666.zip)。
