...
此外，我们还提供了 C 接口和 C++ 接口的 SDK，您可以从这里下载：[下载 C API 版本](https://im.sdk.qcloud.com/download/plus/8.1.6103/cross_platform/ImSDK_Android_C_8.1.6103.zip)、[下载 C++ API 版本](https://im.sdk.qcloud.com/download/plus/8.1.6103/cross_platform/ImSDK_Android_CPP_8.1.6103.zip)。
