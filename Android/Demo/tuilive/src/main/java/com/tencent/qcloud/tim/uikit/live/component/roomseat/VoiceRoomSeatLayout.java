package com.tencent.qcloud.tim.uikit.live.component.roomseat;
...
import com.tencent.qcloud.tim.uikit.live.component.audiosettingkit.CircleImageView;
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final Context context, final VoiceRoomSeatEntity entity) {
                ...
                if (entity.isClose) {
                    ...
                    mTextView.setText(TUILiveService.getAppContext().getString(R.string.seat_lock));
                ...
                if (!entity.isUsed) {
                    ...
                    if (!TextUtils.isEmpty(entity.userName)) {
                        ...
                        mTextView.setText(TUILiveService.getAppContext().getString(R.string.find_anchor));
                    }
                }
                if (entity.isMute) {
