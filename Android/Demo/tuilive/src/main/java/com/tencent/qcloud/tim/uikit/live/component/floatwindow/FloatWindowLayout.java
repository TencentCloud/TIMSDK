package com.tencent.qcloud.tim.uikit.live.component.floatwindow;
...
public class FloatWindowLayout extends ConstraintLayout {
    ...
    public static synchronized FloatWindowLayout getInstance() {
        if (sInstance == null) {
            sInstance = new FloatWindowLayout(TUILiveService.getAppContext());
        }
        return sInstance;
    }
    ...
    private void startActivity() {
        if (mIntentParams != null) {
            ...
            intent.putExtra(Constants.ROOM_ID, mIntentParams.roomId);
