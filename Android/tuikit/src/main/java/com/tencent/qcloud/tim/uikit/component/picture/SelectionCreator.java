...
public final class SelectionCreator {
    ...
    public void forResult(int requestCode) {
        ...
        Intent intent = new Intent(activity, MatissePickerActivity.class);
        MatissePickerActivity.mCallback = null;
    ...
    public void forResult(IUIKitCallBack callBack) {
        ...
        Intent intent = new Intent(activity, MatissePickerActivity.class);
        MatissePickerActivity.mCallback = callBack;
        Fragment fragment = mMatisse.getFragment();
        if (fragment != null) {
