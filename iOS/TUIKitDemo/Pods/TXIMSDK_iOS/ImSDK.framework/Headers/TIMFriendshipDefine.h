 ...
 *  获取指定好友资料请求
 */
typedef void (^TIMFriendGetResultSucc)(NSArray<TIMFriendGetResult *> *friendGetResults);
 ...
 *  获取指定好友资料请求
 */
@interface TIMFriendGetResult : TIMCodingModel
 ...
 *  好友类型
 */
@property(nonatomic,assign) TIMFriendRelationType relation;

/**
 *  获取好友资料，如果不是好友除了 identifier 字段，其他字段都为空
 */
@property(nonatomic,strong) TIMFriend *timFriend;
@end
