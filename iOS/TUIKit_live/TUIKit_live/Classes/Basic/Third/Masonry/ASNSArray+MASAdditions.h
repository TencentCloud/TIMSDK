...
typedef NS_ENUM(NSUInteger, ASMASAxisType) {
    ASMASAxisTypeHorizontal,
    ASMASAxisTypeVertical
};

@interface NSArray (ASMASAdditions)

/**
 *  Creates a ASMASConstraintMaker with each view in the callee.
