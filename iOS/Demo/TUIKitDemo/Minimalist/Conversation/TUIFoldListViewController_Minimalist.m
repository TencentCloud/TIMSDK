...
- (void)viewDidLoad {
    ...
    self.conv.provider = [[TUIFoldConversationListDataProvider_Minimalist alloc] init];
...
- (void)excuteDismissCallback {
    if (self.dismissCallback) {
        ...
        TUIFoldConversationListDataProvider_Minimalist * foldProvider = (TUIFoldConversationListDataProvider_Minimalist *)self.conv.provider;
