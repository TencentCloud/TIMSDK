...
- (void)setupView {
    ...
    [self.editButton setTitle:NSLocalizedString(@"ProfileEdit", nil) forState:UIControlStateNormal];
...
@interface ProfileController_Minimalist () <UIActionSheetDelegate, V2TIMSDKListener, TModifyViewDelegate>
...
@implementation ProfileController_Minimalist {
...
- (void)setupViews
{
    ...
    [_titleView setTitle:NSLocalizedString(@"ProfileInfo", nil)];
...
//    TUICoreDynamicColor(@"controller_bg_color", @"#F2F3F5");
