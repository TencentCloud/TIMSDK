...
static void *tui_kUIViewLayoutMethodPropertyBottomGap = &tui_kUIViewLayoutMethodPropertyBottomGap;
static void *tui_kUIViewLayoutMethodPropertyTopGap = &tui_kUIViewLayoutMethodPropertyTopGap;
static void *tui_kUIViewLayoutMethodPropertyLeftGap = &tui_kUIViewLayoutMethodPropertyLeftGap;
static void *tui_kUIViewLayoutMethodPropertyRightGap = &tui_kUIViewLayoutMethodPropertyRightGap;

- (CGFloat)mm_safeAreaBottomGap
{
    NSNumber *gap = objc_getAssociatedObject(self, tui_kUIViewLayoutMethodPropertyBottomGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, tui_kUIViewLayoutMethodPropertyBottomGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
{
    NSNumber *gap = objc_getAssociatedObject(self, tui_kUIViewLayoutMethodPropertyTopGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, tui_kUIViewLayoutMethodPropertyTopGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
...
{
    NSNumber *gap = objc_getAssociatedObject(self, tui_kUIViewLayoutMethodPropertyLeftGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, tui_kUIViewLayoutMethodPropertyLeftGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
...
{
    NSNumber *gap = objc_getAssociatedObject(self, tui_kUIViewLayoutMethodPropertyRightGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, tui_kUIViewLayoutMethodPropertyRightGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
