 ...
 *
 *  TUIGroupMembersCellDelegate 协议实现了具体某一 membersCell 的点击响应回调。
 *  TUIGroupMembersCellData 类存放了群成员的群组，即在群组“详细资料”界面中要显示的群成员。当前默认显示群组内的前10个成员。
...
/**
 *  委托类，负责实现 TUIGroupMembersCellDelegate 协议中的委托。
 */
