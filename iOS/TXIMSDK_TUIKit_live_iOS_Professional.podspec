Pod::Spec.new do |spec|
  ...
  spec.dependency 'TXIMSDK_iOS', '5.1.14'
  ...
  spec.source = { :http => 'https://imsdk-1252463788.cos.ap-guangzhou.myqcloud.com/5.1.14/TIM_SDK_TUIKIT_LIVE_iOS_latest_framework.zip'}
