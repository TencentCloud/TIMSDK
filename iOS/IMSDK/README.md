...
In addition, we also provide SDKs for the C and C++ API, which you can download from here，[Download C API Edition](https://im.sdk.qcloud.com/download/plus/8.1.6103/cross_platform/ImSDK_iOS_C_8.1.6103.framework.zip), [Download  C++ API Edition](https://im.sdk.qcloud.com/download/plus/8.1.6103/cross_platform/ImSDK_iOS_CPP_8.1.6103.framework.zip).
