...
In addition, we also provide SDKs for the C and C++ API, which you can download from here，[Download C API Edition](https://im.sdk.qcloud.com/download/plus/9.1.7818/cross_platform/ImSDK_iOS_C_9.1.7818.framework.zip), [Download  C++ API Edition](https://im.sdk.qcloud.com/download/plus/9.1.7818/cross_platform/ImSDK_iOS_CPP_9.1.7818.framework.zip).
