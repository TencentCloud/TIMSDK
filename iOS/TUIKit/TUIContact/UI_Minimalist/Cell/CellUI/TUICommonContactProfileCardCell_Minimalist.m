...
@implementation TUICommonContactProfileCardCellData_Minimalist
...
{
    return kScale390(43) + 2 * kScale390(10) + (self.showSignature ? 24 : 0);
}

@end

@implementation TUICommonContactProfileCardCell_Minimalist
...
- (void)setupViews
{
    CGSize headSize = CGSizeMake(kScale390(43), kScale390(43));
    ...
    [_name setFont:[UIFont boldSystemFontOfSize:kScale390(16)]];
...
- (void)layoutSubviews
{
    ...
    _name.mm_sizeToFitThan(0, _avatar.mm_h/3).mm_top(_avatar.mm_y).mm_left(_avatar.mm_maxX + kScale390(18));
    ...
    _genderIcon.mm_sizeToFitThan(_name.font.pointSize * 0.9, _name.font.pointSize * 0.9).mm__centerY(_name.mm_centerY).mm_left(_name.mm_x + _name.mm_w + kScale390(10));
}
