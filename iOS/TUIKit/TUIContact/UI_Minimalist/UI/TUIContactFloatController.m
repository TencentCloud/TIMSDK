...
@interface TUIContactFloatTitleView ()

@end

@implementation TUIContactFloatTitleView
...
@interface TUIContactFloatController ()

@property (nonatomic, assign) CGFloat topMargin;

@property (nonatomic, strong) UIViewController<TUIContactFloatSubViewControllerProtocol> * childVC;
...
@implementation TUIContactFloatController
...
- (UIView *)topGestureView {
    if (_topGestureView == nil) {
        _topGestureView = [[TUIContactFloatTitleView alloc] init];
