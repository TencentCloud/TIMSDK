...
+ (void)load {
    [TUICore registerObjectFactoryName:TUICore_TUIContactObjectFactory objectFactory:[TUIContactObjectFactory shareInstance]];
}
...
- (id)onCreateObject:(NSString *)method param:(nullable NSDictionary *)param {
    if ([method isEqualToString:TUICore_TUIContactObjectFactory_GetContactControllerMethod]) {
        ...
        ProfileControllerAction action = (ProfileControllerAction)([[param objectForKey:TUICore_TUIContactObjectFactory_GetUserProfileControllerMethod_ActionTypeKey] unsignedIntegerValue]);
