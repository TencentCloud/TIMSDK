...
- (void)layoutSubviews
{
    ...
    if (self.isFooter) {
        ...
        self.moreBtn.frame = CGRectMake(self.contentView.frame.size.width - self.moreBtn.frame.size.width - kScale390(20), (self.contentView.frame.size.height - self.moreBtn.frame.size.height ) *0.5 , self.moreBtn.frame.size.width, self.moreBtn.frame.size.height);
    }
}
