...
+ (void)load {
    [TUICore registerObjectFactoryName:TUICore_TUIGroupObjectFactory_Minimalist objectFactory:[TUIGroupObjectFactory_Minimalist shareInstance]];
}
...
- (id)onCreateObject:(NSString *)method param:(nullable NSDictionary *)param {
    ...
    if ([method isEqualToString:TUICore_TUIGroupObjectFactory_GetGroupRequestViewControllerMethod]) {
        returnObject = [self createGroupRequestViewController:[param tui_objectForKey:TUICore_TUIGroupObjectFactory_GetGroupRequestViewControllerMethod_GroupInfoKey
                                                                       asClass:V2TIMGroupInfo.class]];
        
    } else if ([method isEqualToString:TUICore_TUIGroupObjectFactory_GetGroupInfoControllerMethod]) {
        returnObject = [self createGroupInfoController:[param tui_objectForKey:TUICore_TUIGroupObjectFactory_GetGroupInfoControllerMethod_GroupIDKey
                                                                       asClass:NSString.class]];
        
    } else if ([method isEqualToString:TUICore_TUIGroupObjectFactory_SelectGroupMemberVC]) {
        NSString *groupID            = [param tui_objectForKey:TUICore_TUIGroupObjectFactory_SelectGroupMemberVC_GroupID
                                                      asClass:NSString.class];
        NSString *title              = [param tui_objectForKey:TUICore_TUIGroupObjectFactory_SelectGroupMemberVC_Name
                                                      asClass:NSString.class];
        NSNumber *optionalStyleNum   = [param tui_objectForKey:TUICore_TUIGroupObjectFactory_SelectGroupMemberVC_OptionalStyle
                                                     asClass:NSNumber.class];
        NSArray  *selectedUserIDList = [param tui_objectForKey:TUICore_TUIGroupObjectFactory_SelectGroupMemberVC_SelectedUserIDList
