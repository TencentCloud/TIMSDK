...
#define tui_mm_weakify(object) autoreleasepool   {} __weak  typeof(object) weak##object = object;
#define tui_mm_strongify(object) autoreleasepool {} __strong  typeof(weak##object) object = weak##object;
