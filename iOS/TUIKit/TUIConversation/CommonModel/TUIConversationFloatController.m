//
//  TUIConversationFloatController.m
//  TUIConversation
//
...
@interface TUIConversationFloatTitleView ()

@end

@implementation TUIConversationFloatTitleView
...
- (void)setupView {
    ...
    [self.rightButton setTitleColor:[UIColor tui_colorWithHex:@"#0365F9" alpha:0.3] forState:UIControlStateDisabled];
}
...
@interface TUIConversationFloatController ()
...
@implementation TUIConversationFloatController
...
- (UIView *)topGestureView {
    if (_topGestureView == nil) {
        _topGestureView = [[TUIConversationFloatTitleView alloc] init];
