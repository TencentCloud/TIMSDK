...
+ (void)load {
    gCustomMessageInfo = [NSMutableArray arrayWithArray:@[
        @{BussinessID : BussinessID_TextLink, TMessageCell_Name : @"TUILinkCell", TMessageCell_Data_Name : @"TUILinkCellData"},
        @{BussinessID : BussinessID_GroupCreate, TMessageCell_Name : @"TUIGroupCreatedCell", TMessageCell_Data_Name : @"TUIGroupCreatedCellData"},
        @{BussinessID : BussinessID_Evaluation, TMessageCell_Name : @"TUIEvaluationCell", TMessageCell_Data_Name : @"TUIEvaluationCellData"},
        @{BussinessID : BussinessID_Order, TMessageCell_Name : @"TUIOrderCell", TMessageCell_Data_Name : @"TUIOrderCellData"},
...
+ (BOOL)judgeCurrentDataPluginMsg:(TUIMessageCellData *)data {
    NSMutableArray *gPluginCustomMessageInfo = [TUIMessageDataProvider getPluginCustomMessageInfo];
    NSMutableArray *currentCustomMessageBussinessIDArray = [NSMutableArray array];
    for (NSDictionary *messageInfo in gPluginCustomMessageInfo) {
