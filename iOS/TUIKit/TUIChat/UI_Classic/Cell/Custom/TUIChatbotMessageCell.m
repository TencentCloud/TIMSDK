...
#import "TUIChatbotMessageCell.h"
#import <TIMCommon/TIMDefine.h>
#import <TUICore/TUICore.h>
#import <ImageIO/ImageIO.h>
#import <SDWebImage/SDWebImage.h>

@interface TUIChatbotMessageCell ()
...
@implementation TUIChatbotMessageCell
...
- (void)onImmediateStopRendering:(NSNotification *)notification {
    ...
    if (targetCellData && targetCellData == self.textData) {
...
- (void)immediateStopRendering {
    ...
    if (self.currentTimer) {
        ...
        TUIChatbotMessageCellData *data = (TUIChatbotMessageCellData *)self.textData;
    ...
    NSLog(@"TUIChatbotMessageCell: Immediate stop rendering executed");
}
