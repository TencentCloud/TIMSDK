...
@interface TUIMoreView_Minimalist () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation TUIMoreView_Minimalist
...
- (void)setupViews
{
    ...
    [_moreCollectionView registerClass:[TUIInputMoreCell_Minimalist class] forCellWithReuseIdentifier:TMoreCell_ReuseId];
...
- (void)defaultLayout
{
    CGSize cellSize = [TUIInputMoreCell_Minimalist getSize];
...
{
    TUIInputMoreCell_Minimalist *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMoreCell_ReuseId forIndexPath:indexPath];
    TUIInputMoreCellData_Minimalist *data;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(moreView:didSelectMoreCell:)]){
        if ([cell isKindOfClass:[TUIInputMoreCell_Minimalist class]]) {
            [_delegate moreView:self didSelectMoreCell:(TUIInputMoreCell_Minimalist *)cell];;
        }
    }
}
...
{
    return [TUIInputMoreCell_Minimalist getSize];
}
