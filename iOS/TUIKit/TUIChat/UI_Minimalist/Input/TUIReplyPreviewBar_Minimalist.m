...
- (void)setPreviewReferenceData:(TUIReferencePreviewData_Minimalist *)previewReferenceData {
    ...
    NSString *abstract = [TUIReferencePreviewData_Minimalist displayAbstract:previewReferenceData.type abstract:previewReferenceData.msgAbstract withFileName:YES];
