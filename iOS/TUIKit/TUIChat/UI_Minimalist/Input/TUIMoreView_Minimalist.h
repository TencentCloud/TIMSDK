 ...
 *
 *  TUIMoreView_Minimalist 在已有的文本消息收发基础上提供了视频、图片、文件等多媒体消息的发送入口。
 *  TUIMoreViewDelegate 协议则为更多视图提供了响应回调，以响应用户的操作。
 *
...
@protocol TUIMoreViewDelegate_Minimalist <NSObject>

- (void)moreView:(TUIMoreView_Minimalist *)moreView didSelectMoreCell:(TUIInputMoreCell_Minimalist *)cell;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                             TUIMoreView_Minimalist
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 【模块名称】TUIMoreView_Minimalist
 ...
 */
@interface TUIMoreView_Minimalist : UIView
...
@property (nonatomic, weak) id<TUIMoreViewDelegate_Minimalist> delegate;
