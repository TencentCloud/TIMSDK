...
- (NSArray<TUICustomActionSheetItem *> *)customInputMoreActionItemList {
    if (_customInputMoreActionItemList == nil) {
        ...
        if (TUIChatConfig.defaultConfig.enableWelcomeCustomMessage) {
            ...
            TUICustomActionSheetItem *link = [[TUICustomActionSheetItem alloc] initWithTitle:TIMCommonLocalizableString(TUIKitMoreLink)
...
- (NSArray<TUICustomActionSheetItem *> *)builtInInputMoreActionItemList {
    if (_builtInInputMoreActionItemList == nil) {
        __weak typeof(self) weakSelf = self;
        TUICustomActionSheetItem *photo = [[TUICustomActionSheetItem alloc] initWithTitle:TIMCommonLocalizableString(TUIKitMorePhoto)
        ...
        TUICustomActionSheetItem *camera = [[TUICustomActionSheetItem alloc] initWithTitle:TIMCommonLocalizableString(TUIKitMoreCamera)
        ...
        TUICustomActionSheetItem *video = [[TUICustomActionSheetItem alloc] initWithTitle:TIMCommonLocalizableString(TUIKitMoreVideo)
        ...
        TUICustomActionSheetItem *file = [[TUICustomActionSheetItem alloc] initWithTitle:TIMCommonLocalizableString(TUIKitMoreFile)
...
- (NSArray<TUICustomActionSheetItem *> *)getInputMoreActionItemList:(NSString *)userID groupID:(NSString *)groupID pushVC:(UINavigationController *)pushVC {
