//
//  TUIReplyPreviewData_Minimalist.h
//  TUIChat
//
...
@interface TUIReplyPreviewData_Minimalist : NSObject
...
@interface TUIReferencePreviewData_Minimalist : TUIReplyPreviewData_Minimalist
