    ...
    [message doThingsInContainsCloudCustomOfDataType:TUICloudCustomDataType_MessageReply callback:^(BOOL isContains, id obj) {
        ...
        if (isContains) {
            if(obj && [obj isKindOfClass:NSDictionary.class]) {
                ...
                replyData = [[TUIReplyMessageCellData_Minimalist alloc] initWithDirection:(message.isSelf ? MsgDirectionOutgoing : MsgDirectionIncoming)];
...
- (CGSize)contentSize
{
    ...
    CGRect replyContentRect2 = [attributeString boundingRectWithSize:CGSizeMake(MAXFLOAT, [font lineHeight]) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading context:nil];
       ...
       if (isContains) {
           if(obj && [obj isKindOfClass:NSDictionary.class]) {
               ...
               if ([reply isKindOfClass:NSDictionary.class]) {
                   ...
                   replyData = [[TUIReferenceMessageCellData_Minimalist alloc] initWithDirection:(message.isSelf ? MsgDirectionOutgoing : MsgDirectionIncoming)];
...
- (CGSize)contentSize{
    ...
    CGRect replyContentRect2 = [attributeString boundingRectWithSize:CGSizeMake(MAXFLOAT, [textFont lineHeight]) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading context:nil];
