 /**
  * 本文件声明了 TUITextMessageCellData_Minimalist 类。
...
/** 
 * 【模块名称】TUITextMessageCellData_Minimalist
 * 【功能说明】文本消息单元数据源。
 *  - 文本消息单元，即在多数消息收发情况下最常见的消息单元。
 *  - 文本消息单元数据源则是为文本消息单元提供一系列所需的数据与信息。
 *
 * 【Module name】 TUITextMessageCellData_Minimalist
 ...
 */
@interface TUITextMessageCellData_Minimalist : TUIBubbleMessageCellData_Minimalist
