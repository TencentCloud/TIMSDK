...
+ (TUIGroupCreatedCellData_Minimalist *)getCellData:(V2TIMMessage *)message {
    ...
    TUIGroupCreatedCellData_Minimalist *cellData =
        [[TUIGroupCreatedCellData_Minimalist alloc] initWithDirection:(message.isSelf ? MsgDirectionOutgoing : MsgDirectionIncoming)];
