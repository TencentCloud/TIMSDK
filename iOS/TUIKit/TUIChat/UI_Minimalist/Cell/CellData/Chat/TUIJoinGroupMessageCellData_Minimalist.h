/**
 *
 *  本文件声明了 TUIJoinGroupMessageCellData_Minimalist 类。
 *  本文件负责实现入群小灰条的功能，同时也能进一步扩展为所有操作者为单人的群组消息单元。
 *  即本文件能够实现将操作者昵称蓝色高亮，并提供蓝色高亮部分的响应接口。
 *
 *  This file declares the TUIJoinGroupMessageCellData_Minimalist class.
...
@interface TUIJoinGroupMessageCellData_Minimalist : TUISystemMessageCellData
