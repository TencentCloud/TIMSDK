...
+ (TUIMessageCellData *)getCellData:(V2TIMMessage *)message {
    ...
    TUIFileMessageCellData_Minimalist *fileData = [[TUIFileMessageCellData_Minimalist alloc] initWithDirection:(message.isSelf ? MsgDirectionOutgoing : MsgDirectionIncoming)];
...
- (void)downloadFile
{
    ...
    if (self.innerMessage.elemType == V2TIM_ELEM_TYPE_FILE) {
        ...
        [self.innerMessage.fileElem downloadFile:path progress:^(NSInteger curSize, NSInteger totalSize) {
            ...
            [TUIMessageProgressManager.shareManager appendProgress:msgID progress:100];
