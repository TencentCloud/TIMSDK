...
- (void)layoutSubviews
{
    ...
    // menuView
    {
        ...
        self.deleteButton.frame = CGRectMake(self.relayButton.frame.origin.x +self.relayButton.frame.size.width + kScale390(17) , kScale390(17), kScale390(16), kScale390(16));
