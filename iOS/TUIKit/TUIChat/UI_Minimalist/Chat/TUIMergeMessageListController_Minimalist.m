    ...
    for (NSInteger k = 0; k < msgs.count; k++) {
        ...
        if ([self.delegate respondsToSelector:@selector(messageController:onNewMessage:)]) {
            ...
            if ([data isKindOfClass:TUITextMessageCellData_Minimalist.class]
                ||[data isKindOfClass:TUIReferenceMessageCellData_Minimalist.class]) {
...
- (void)onJumpToRepliesDetailPage:(TUIMessageCellData *)data {
    TUIRepliesDetailViewController_Minimalist *repliesDetailVC = [[TUIRepliesDetailViewController_Minimalist alloc] initWithCellData:data conversationData:self.conversationData];
