...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if (oneScreenCanFillCheck) {
        ...
        self.recentView.frame = CGRectMake(self.recentView.frame.origin.x  - moveX, recentViewMoveY , self.recentView.frame.size.width, self.recentView.frame.size.height);
 
        //alertView
        [UIView animateWithDuration:0.3 animations:^{
            self.alertView.container.frame = CGRectMake(self.originFrame.origin.x,self.recentView.frame.origin.y +kScale390(8) +self.recentView.frame.size.height , self.originFrame.size.width, self.originFrame.size.height);
        ...
        self.extionView.frame = CGRectMake(self.extionView.frame.origin.x - moveX, self.extionView.frame.origin.y + extionViewMoveY, self.extionView.frame.size.width, self.extionView.frame.size.height);
        ...
        if (moveY != 0) {
            [UIView animateWithDuration:0.3 animations:^{
                self.alertView.container.frame = CGRectMake(self.originFrame.origin.x,self.originFrame.origin.y + moveY , self.originFrame.size.width, self.originFrame.size.height);
        ...
        self.recentView.frame = CGRectMake(self.recentView.frame.origin.x - moveX, self.recentView.frame.origin.y ,
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            CGRectMake(self.recentView.frame.origin.x , self.recentView.frame.origin.y + moveY, self.recentView.frame.size.width, self.recentView.frame.size.height);
        } completion:^(BOOL finished) {
            
        }];
        
        self.extionView.frame = CGRectMake(self.extionView.frame.origin.x - moveX, self.extionView.frame.origin.y + moveY, self.extionView.frame.size.width, self.extionView.frame.size.height);
        self.extionView.transform = CGAffineTransformMakeScale(0.1, 0.1);
        [UIView animateWithDuration:0.5 animations:^{
            //Bounces
            self.extionView.transform = CGAffineTransformMakeScale(1, 1);
...
- (void)configRecentView
{
    ...
    _recentView.frame =
    CGRectMake(_originFrame.origin.x, _originFrame.origin.y - kScale390(8 + 40), kScale390(208), kScale390(40));
}
...
{
    [UIView animateWithDuration:0.3 animations:^{
        self.recentView.frame = CGRectMake(self.recentView.frame.origin.x , self.originFrame.origin.y - self.recentView.frame.size.height , self.recentView.frame.size.width, self.recentView.frame.size.height);
    } completion:^(BOOL finished) {
        
    }];
    
    [UIView animateWithDuration:0.3 animations:^{
        self.alertView.container.frame = CGRectMake(self.originFrame.origin.x,self.originFrame.origin.y , self.originFrame.size.width, self.originFrame.size.height);
    } completion:^(BOOL finished) {
        if (finished) {
