Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://sdk-im-1252463788.cos.ap-hongkong.myqcloud.com/download/tuikit/5.9.1872/ios/TUIConversation.zip'}

  spec.subspec 'Cell' do |cell|
    cell.subspec 'CellData' do |cellData|
      cellData.source_files = '**/TUIConversation/Cell/CellData/*.{h,m,mm}'
      cellData.dependency 'TUICore','5.9.1872'
    end
