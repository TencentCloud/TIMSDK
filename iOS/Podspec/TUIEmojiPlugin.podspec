Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuikit/8.4.6667/ios/TUIEmojiPlugin.zip?time=4'}

  spec.dependency 'TUICore'
  spec.dependency 'TIMCommon','~>8.4.6667'
  spec.dependency 'TUIChat','~>8.4.6667'
