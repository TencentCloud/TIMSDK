Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuikit/8.2.6325/ios/TUIEmojiPlugin.zip?time=4'}
  ...
  spec.subspec 'CommonModel' do |ss|
    ...
    ss.dependency 'TIMCommon','~>8.2.6325'
    ss.dependency 'TUIChat','~>8.2.6325'
  end
