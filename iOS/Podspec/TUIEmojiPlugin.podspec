Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuikit/8.3.6498/ios/TUIEmojiPlugin.zip?time=4'}

  spec.dependency 'TUICore'
  spec.dependency 'TIMCommon','~>8.3.6498'
  spec.dependency 'TUIChat','~>8.3.6498'
