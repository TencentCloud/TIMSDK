...
Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/plus/7.1.3925/ImSDK_Plus_7.1.3925_Bitcode.framework.zip'}
  ...
  spec.xcconfig = { 'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/TXIMSDK_Plus_iOS_Bitcode/ImSDK_Plus.framework/Headers/, ${PODS_ROOT}/TXIMSDK_Plus_iOS_Bitcode/ImSDK_Plus.framework/cpluscplus/include/'}
