Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuikit/8.2.6325/ios/TUICustomerServicePlugin.zip'}
  ...
  spec.subspec 'CommonModel' do |commonModel|
    ...
    commonModel.dependency 'TUIChat/UI_Classic', '~> 8.2.6325'
    commonModel.dependency 'TUIContact/UI_Classic','~> 8.2.6325'
  end
