...
Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/plus/7.2.4146/ImSDK_Plus_Scenario_7.2.4146.framework.zip'}
  ...
  spec.xcconfig = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/TXIMSDK_Customer_iOS/ImSDK_Plus.framework/Headers/'}
