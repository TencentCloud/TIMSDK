...
class _GroupProfileMemberListState
  ...
  Widget _buildListItem(BuildContext context,
      V2TimGroupMemberFullInfo memberInfo, OurSchoolMember? ourSchoolMember) {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    final showList = _getShowList(
      widget.memberList
          .where((element) =>
              ourSchoolChatProvider.getMemberByIMId(element?.userID) != null)
          .toList(),
            ...
            child: AZListViewContainer(
                ...
                itemBuilder: (context, index) {
                  ...
                  final OurSchoolMember? ourSchoolMember =
                      ourSchoolChatProvider.getMemberByIMId(memberInfo.userID);

                  return _buildListItem(context, memberInfo, ourSchoolMember);
                }),
          ))
        ],
      )),
