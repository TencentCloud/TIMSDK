			...
			<view class="box">
				<view class="list">
					<view class="list-item">
						...
						<input class="input" type="text" placeholder="请输入用户名" @input='bindUserIDInput'
				...
				<view class="private-protocol-box">
					...
					<view class="text-box"><text>我已阅读并同意</text><text class="link"
							@tap="linkToPrivacyTreaty">《隐私条例》</text><text>和</text><text class="link"
							@tap="linkToUserAgreement">《用户协议》</text>
					</view>
				</view>
				<view class="login">
