...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__static_utils_GenerateTestUserSig__ = __webpack_require__(37);
...
tim.on(__WEBPACK_IMPORTED_MODULE_2_tim_wx_sdk___default.a.EVENT.GROUP_SYSTEM_NOTICE_RECEIVED, function (event) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_index__ = __webpack_require__(23);
  ...
  mutations: {
    ...
    unshiftMessageList: function unshiftMessageList(state, messageList) {
      ...
      for (var i = 0; i < list.length; i++) {
        var message = list[i];
        list[i].virtualDom = Object(__WEBPACK_IMPORTED_MODULE_2__utils_decodeElement__["a" /* decodeElement */])(message);
    ...
    sendMessage: function sendMessage(state, message) {
      message.virtualDom = Object(__WEBPACK_IMPORTED_MODULE_2__utils_decodeElement__["a" /* decodeElement */])(message);
      var date = new Date(message.time * 1000);
...
function parseGroupSystemNotice(message) {
  ...
  var groupName = payload.groupProfile.groupName || payload.groupProfile.groupID;
  var text = void 0;
...
var groupModules = {
  ...
  mutations: {
    ...
    setCurrentGroupMemberList: function setCurrentGroupMemberList(state, groupMemberList) {
      state.currentGroupMemberList = [].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(groupMemberList));
    }
  },
  actions: {
