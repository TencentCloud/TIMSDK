...
@class V2TIMGroupMessageReceipt;
@class V2TIMGroupMessageReadMembers;
...
/// 获取群消息已读回执的结果回调
typedef void (^V2TIMGroupMessageReceiptListSucc)(NSArray<V2TIMGroupMessageReceipt*> *receiptList);
/// 获取群消息已读群成员列表
typedef void (^V2TIMGroupMessageReadMembersSucc)(NSMutableArray<V2TIMGroupMemberInfo*>* members, uint64_t nextSeq, BOOL isFinished);
 ...
 */
- (void)sendGroupMessageReceipts:(NSArray<V2TIMMessage *>*)messageList succ:(V2TIMSucc)succ fail:(V2TIMFail)fail;

/**
 *  6.2 获取群消息已读回执
 *  @param messageList 消息列表
 */
- (void)getGroupMessageReceipts:(NSArray<V2TIMMessage *>*)messageList succ:(V2TIMGroupMessageReceiptListSucc)succ fail:(V2TIMFail)fail;
 ...
 */
- (void)getGroupMessageReadMembers:(V2TIMMessage*)message filter:(V2TIMGroupMessageReadMembersFilter)filter nextSeq:(uint64_t)nextSeq count:(uint32_t)count succ:(V2TIMGroupMessageReadMembersSucc)succ fail:(V2TIMFail)fail;
...
/// 收到群聊消息已读回执
- (void)onRecvGroupReadReceipt:(NSArray<V2TIMGroupMessageReceipt *> *)receiptList;
...
/// Group 消息已读回执
@interface V2TIMGroupMessageReceipt : NSObject
...
/// 只有华为和谷歌手机支持设置声音提示，小米手机设置声音提示，请您参照：https://dev.mi.com/console/doc/detail?pId=1278#_3_0
