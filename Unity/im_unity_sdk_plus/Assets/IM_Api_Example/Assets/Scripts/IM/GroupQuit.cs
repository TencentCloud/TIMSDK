...
public class GroupQuit : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(GroupQuitSDK);
  ...
  void GroupQuitSDK()
  {
    ...
    TIMResult res = TencentIMSDK.GroupQuit(groupID, Utils.addAsyncNullDataToScreen(GetResult));
