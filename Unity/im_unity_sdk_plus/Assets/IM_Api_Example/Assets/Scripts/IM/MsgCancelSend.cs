...
public class MsgCancelSend : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(MsgCancelSendSDK);
  ...
  void MsgCancelSendSDK()
  {
    ...
    string msg_id = MsgList[SelectedMsg.value].message_msg_id;
    TIMResult res = TencentIMSDK.MsgCancelSend(conv_id, conv_type, msg_id, Utils.addAsyncStringDataToScreen(GetResult));
