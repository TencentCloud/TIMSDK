...
public class FriendshipDeleteFromBlackList : MonoBehaviour
{
  string[] Labels = new string[] { "SelectBlackLabel" };
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(FriendshipDeleteFromBlackListSDK);
  ...
  void GetBlackList(params object[] parameters)
  {
    try
    {
    ...
    {
      Toast.Show(Utils.t("getBlackListFailed"));
    }
  }
  void FriendshipGetFriendProfileListSDK()
  {
    TIMResult res = TencentIMSDK.FriendshipGetBlackList(Utils.addAsyncStringDataToScreen(GetBlackList));
    print($"FriendshipGetFriendProfileListSDK {res}");
  }

  void FriendshipDeleteFromBlackListSDK()
  {
    ...
    TIMResult res = TencentIMSDK.FriendshipDeleteFromBlackList(list, Utils.addAsyncStringDataToScreen(GetResult));
