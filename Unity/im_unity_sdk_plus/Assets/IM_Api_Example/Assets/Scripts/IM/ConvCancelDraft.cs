...
public class ConvCancelDraft : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(ConvCancelDraftSDK);
  ...
  void ConvCancelDraftSDK()
  {
    ...
    TIMResult res = TencentIMSDK.ConvCancelDraft(conv_id, conv_type);
