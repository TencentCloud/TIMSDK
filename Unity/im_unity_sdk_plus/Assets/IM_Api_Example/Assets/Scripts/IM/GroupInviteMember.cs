...
public class GroupInviteMember : MonoBehaviour
{
  public Text Header;
  ...
  void Start()
  {
    ...
    Submit.onClick.AddListener(GroupInviteMemberSDK);
  ...
  void GroupInviteMemberSDK()
  {
    ...
    var param = new GroupInviteMemberParam
    {
      ...
      group_invite_member_param_user_data = CustomData.text
    };
    TIMResult res = TencentIMSDK.GroupInviteMember(param, Utils.addAsyncStringDataToScreen(GetResult));
